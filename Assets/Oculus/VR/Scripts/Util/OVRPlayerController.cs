...
public class OVRPlayerController : MonoBehaviour
{
    ...
    public bool bockMovementInTheAir = false;
    ...
    public virtual void UpdateMovement()
    {
        ...
        if (EnableLinearMovement)
        {
            ...
            if (bockMovementInTheAir && !Controller.isGrounded)
                MoveScale = 0.0f;
        ...
        if (EnableRotation)
        {
            ...
            {
                //if (euler.y != 0) 
                //	Debug.Log("we rotate around tracking space");
                //transform.RotateAround(CameraRig.centerEyeAnchor.position, Vector3.up, euler.y);
                CameraRig.trackingSpace.transform.Rotate(euler, Space.Self);
            }
        }
#endif
    }
